...
def student_dashboard():
    ...
    for i, sub_node in enumerate(subjects):
        ...
        # ✅ sid=sid and sub=sub as default args prevents Python closure bug
        def unenroll_button(sid=sid, sub=sub):
            if st.button(
                ...
                key=f'unenroll_{sid}'  # ✅ unique key per subject card
            ):
...
def student_screen():
    ...
    # Initialize session state for registration visibility
    ...
    if photo_source:
        ...
        # Camera was cleared — hide registration form
        st.session_state.show_registration = False

    # ✅ Persists correctly across reruns
    if st.session_state.show_registration:
        with st.container(border=True):
            st.header('Register new Profile')
            new_name = st.text_input("Enter your name", placeholder='E.g. Deeksha Dhatterwal')
